...
# 레이어 설정
# 아래에서 위 순서...?
define config.layers = [ 'master', 'mask_layer','transient','screens','overlay' ]
...
define config.save_directory = "Tinde-1701704636"
